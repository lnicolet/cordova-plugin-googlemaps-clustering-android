...
import plugin.google.maps.clustering.clustering.algo.Algorithm;
import plugin.google.maps.clustering.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import plugin.google.maps.clustering.clustering.algo.PreCachingAlgorithmDecorator;
import plugin.google.maps.clustering.clustering.view.ClusterRenderer;
...
//    public HashMap<String, JSONObject> plugins = new HashMap<String, JSONObject>();
...
//        this.objects.clear();
//        this.plugins.clear();
//        this.markers = new JSONArray(new ArrayList());
//
//        Log.d("GoogleMapsPlugin", "clear caches: " + markers.length());
//    }
    ...
    public void onCameraChange(CameraPosition cameraPosition) {
        if (mRenderer instanceof GoogleMap.OnCameraChangeListener) {
            ...
            Log.d("GoogleMapsPlugin", "Renderer on Camera changed");
        }
        ...
        Log.d("GoogleMapsPlugin", "mMarkers = " + mMarkers.getMarkers().size());
//        if (mMap.getCameraPosition().zoom < 14 && mMarkers.getMarkers().size() == 0) {
//            this.clear();
//        }
        cluster();
    }
    ...
    @Nullable
    public Marker getMarkerFromPos(LatLng position){
        Marker result = null;
        for (Marker m : mMarkers.getMarkers()){
